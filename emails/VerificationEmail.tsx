      ...
      <Section style={main}>
        ...
        <Container style={container}>
          <Section style={logoContainer}>
            <table style={{ width: "100%", textAlign: "center" }}>
              <tr>
                ...
                <td style={logoText}>FreshLeap</td>
              </tr>
            </table>
          </Section>
          ...
          <Section style={ctaSection}>
            <Button
              style={button}
              href={`https://freshleap.yash14.me/verify/${username}`}
            >
              Verify My Account
            </Button>
          </Section>
          ...
          <Section style={messageSection}>
            ...
            <Text style={message}>
              Thank you for joining FreshLeap! We&apos;re excited to have you on
              board. To ensure the security of your account, we need to verify
              your email address.
            </Text>
            <Text style={message}>
