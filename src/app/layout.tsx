...
const toastStyles = {
  toastOptions: {
    classNames: {
      toast: "bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg",
      title: "text-gray-900 dark:text-white font-medium",
      description: "text-gray-700 dark:text-gray-300",
      actionButton: "bg-blue-600 text-white hover:bg-blue-700",
      cancelButton: "text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200",
